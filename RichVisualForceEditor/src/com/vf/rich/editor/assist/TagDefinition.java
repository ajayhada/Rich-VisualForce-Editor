...
public class TagDefinition {
	...
	static {
		...
		Tag html5a = new Tag("a",false);
		Tag html5abbr = new Tag("abbr",false);
		Tag html5acronym = new Tag("acronym",false);
		Tag html5address = new Tag("address",false);
		Tag html5applet = new Tag("applet",false);
		Tag html5area = new Tag("area",false);
		Tag html5article = new Tag("article",false);
		Tag html5aside = new Tag("aside",false);
		Tag html5audio = new Tag("audio",false);
		Tag html5b = new Tag("b",false);
		Tag html5base = new Tag("base",false);
		Tag html5basefont = new Tag("basefont",false);
		Tag html5bdi = new Tag("bdi",false);
		Tag html5bdo = new Tag("bdo",false);
		Tag html5big = new Tag("big",false);
		Tag html5blockquote = new Tag("blockquote",false);
		Tag html5body = new Tag("body",false);
		Tag html5br = new Tag("br",false);
		Tag html5button = new Tag("button",false);
		Tag html5canvas = new Tag("canvas",false);
		Tag html5caption = new Tag("caption",false);
		Tag html5center = new Tag("center",false);
		Tag html5cite = new Tag("cite",false);
		Tag html5code = new Tag("code",false);
		Tag html5com = new Tag("col",false);
		Tag html5colgroup = new Tag("colgroup",false);
		Tag html5command = new Tag("command",false);
		Tag html5datalist = new Tag("datalist",false);
		Tag html5dd = new Tag("dd",false);
		Tag html5del = new Tag("del",false);
		Tag html5details = new Tag("details",false);
		Tag html5dfn = new Tag("dfn",false);
		Tag html5dir = new Tag("dir",false);
		Tag html5div = new Tag("div",false);
		Tag html5dl = new Tag("dl",false);
		Tag html5dt = new Tag("dt",false);
		Tag html5em = new Tag("em",false);
		Tag html5embed = new Tag("embed",false);
		Tag html5fieldset = new Tag("fieldset",false);
		Tag html5figcaption = new Tag("figcaption",false);
		Tag html5figure = new Tag("figure",false);
		Tag html5font = new Tag("font",false);
		Tag html5footer = new Tag("footer",false);
		Tag html5form = new Tag("form",false);
		Tag html5frame = new Tag("frame",false);
		Tag html5frameset = new Tag("frameset",false);
		Tag html5h1 = new Tag("h1",false);
		Tag html5h2 = new Tag("h2",false);
		Tag html5h3 = new Tag("h3",false);
		Tag html5h4 = new Tag("h4",false);
		Tag html5h5 = new Tag("h5",false);
		Tag html5h6 = new Tag("h6",false);
		Tag html5head = new Tag("head",false);
		Tag html5header = new Tag("header",false);
		Tag html5hgroup = new Tag("hgroup",false);
		Tag html5hr = new Tag("hr",false);
		Tag html5html = new Tag("html",false);
		Tag html5i = new Tag("i",false);
		Tag html5iframe = new Tag("iframe",false);
		Tag html5img = new Tag("img",false);
		Tag html5input = new Tag("input",false);
		Tag html5ins = new Tag("ins",false);
		Tag html5keygen = new Tag("keygen",false);
		Tag html5kbd= new Tag("kbd",false);
		Tag html5label = new Tag("label",false);
		Tag html5legand = new Tag("legend",false);
		Tag html5li = new Tag("li",false);
		Tag html5link = new Tag("link",false);
		Tag html5map = new Tag("map",false);
		Tag html5mark = new Tag("mark",false);
		Tag html5menu = new Tag("menu",false);
		Tag html5meta = new Tag("meta",false);
		Tag html5meter = new Tag("meter",false);
		Tag html5nav = new Tag("nav",false);
		Tag html5noframes = new Tag("noframes",false);
		Tag html5noscript = new Tag("noscript",false);
		Tag html5object = new Tag("object",false);
		Tag html5ol = new Tag("ol",false);
		Tag html5optgroup = new Tag("optgroup",false);
		Tag html5option = new Tag("option",false);
		Tag html5output = new Tag("output",false);
		Tag html5p = new Tag("p",false);
		Tag html5param = new Tag("param",false);
		Tag html5pre = new Tag("pre",false);
		Tag html5progress = new Tag("progress",false);
		Tag html5q = new Tag("q",false);
		Tag html5rp = new Tag("rp",false);
		Tag html5rt = new Tag("rt",false);
		Tag html5ruby = new Tag("ruby",false);
		Tag html5s = new Tag("s",false);
		Tag html5samp = new Tag("samp",false);
		Tag html5script = new Tag("script",false);
		Tag html5section = new Tag("section",false);
		Tag html5select = new Tag("select",false);
		Tag html5small = new Tag("small",false);
		Tag html5source = new Tag("source",false);
		Tag html5span = new Tag("span",false);
		Tag html5strike = new Tag("strike",false);
		Tag html5strong = new Tag("strong",false);
		Tag html5style = new Tag("style",false);
		Tag html5sub = new Tag("sub",false);
		Tag html5summary = new Tag("summary",false);
		Tag html5sup = new Tag("sup",false);
		Tag html5table = new Tag("table",false);
		Tag html5tbody = new Tag("tbody",false);
		Tag html5td = new Tag("td",false);
		Tag html5textarea = new Tag("textarea",false);
		Tag html5tfoot = new Tag("tfoot",false);
		Tag html5th = new Tag("th",false);
		Tag html5thead = new Tag("thead",false);
		Tag html5time = new Tag("time",false);
		Tag html5title = new Tag("title",false);
		Tag html5tr = new Tag("tr",false);
		Tag html5track = new Tag("track",false);
		Tag html5tt = new Tag("tt",false);
		Tag html5u = new Tag("u",false);
		Tag html5ul = new Tag("ul",false);
		Tag html5var = new Tag("var",false);
		Tag html5video = new Tag("video",false);
		Tag html5wbr = new Tag("wbr",false);
		Tag html5xmp = new Tag("xmp",false);
	}	
